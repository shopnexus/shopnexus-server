...
\caption{Tóm tắt công nghệ chính}\label{tab:tech-summary}\\
\toprule
\rowcolor{headerblue}
...
\small
\rowcolors{2}{white}{rowgray}
\begin{longtable}{@{}L{2.8cm}L{4.5cm}L{3cm}L{3cm}@{}}
\caption{Phân loại test áp dụng cho ShopNexus}\label{tab:test-types}\\
\toprule
\rowcolor{headerblue}
...
\small
\rowcolors{2}{white}{rowgray}
\begin{longtable}{@{}L{2.8cm}L{3.8cm}L{3.8cm}L{3.8cm}@{}}
...
\caption{Mục tiêu chất lượng code và test}\label{tab:quality-targets}\\
\toprule
\rowcolor{headerblue}
...
\small
\rowcolors{2}{white}{rowgray}
\begin{longtable}{@{}L{2.5cm}L{5cm}L{3.5cm}L{2.8cm}@{}}
\caption{Tiêu chí kiểm thử cho phần hiện thực}\label{tab:impl-test-criteria}\\
\toprule
\rowcolor{headerblue}
