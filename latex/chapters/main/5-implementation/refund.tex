...
\begin{figure}[htbp]
\centering
\fbox{\parbox{0.85\textwidth}{\centering\vspace{3cm}TODO: Screenshot form yêu cầu hoàn trả --- chọn phương thức trả hàng (PickUp/DropOff), lý do, upload ảnh minh chứng\vspace{3cm}}}
\caption{Form tạo yêu cầu hoàn trả}
...
\caption{Trang tranh chấp hoàn trả (Refund Dispute)}
