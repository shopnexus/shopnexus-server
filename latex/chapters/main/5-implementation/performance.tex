...
\begin{longtable}{@{}L{3.2cm}L{3.8cm}L{3.2cm}L{4.2cm}@{}}
\caption{Các kịch bản stress test chính}\label{tab:stress-test-scenarios}\\
\toprule
\rowcolor{headerblue}
...
\small
\rowcolors{2}{white}{rowgray}
\begin{longtable}{@{}L{4.8cm}L{4cm}L{5cm}@{}}
\caption{Ngưỡng chấp nhận cho kiểm thử hiệu năng}\label{tab:perf-thresholds}\\
\toprule
\rowcolor{headerblue}
