...
func TestConvertAmount_SameCurrency(t *testing.T) {
	got := commonbiz.ConvertAmountPure(100_000, "VND", "VND", map[string]decimal.Decimal{"VND": dec(25000)})
	if got != 100_000 {
...
func TestConvertAmount_USDtoVND(t *testing.T) {
	...
	got := commonbiz.ConvertAmountPure(1000, "USD", "VND", map[string]decimal.Decimal{"VND": dec(25000)})
	if got != 250_000 {
...
func TestConvertAmount_VNDtoUSD(t *testing.T) {
	...
	got := commonbiz.ConvertAmountPure(250_000, "VND", "USD", map[string]decimal.Decimal{"VND": dec(25000)})
	if got != 1000 {
...
func TestConvertAmount_JPYtoVND(t *testing.T) {
	...
	got := commonbiz.ConvertAmountPure(10_000, "JPY", "VND",
		map[string]decimal.Decimal{"JPY": dec(155), "VND": dec(25000)})
...
func TestConvertAmount_MissingRate(t *testing.T) {
	...
	got := commonbiz.ConvertAmountPure(100_000, "VND", "XYZ", map[string]decimal.Decimal{"VND": dec(25000)})
	if got != 100_000 {
