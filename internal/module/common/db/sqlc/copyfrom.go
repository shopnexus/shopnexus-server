...
func (q *Queries) CreateCopyResource(ctx context.Context, arg []CreateCopyResourceParams) (int64, error) {
	return q.db.CopyFrom(ctx, []string{"common", "resource"}, []string{"id", "uploaded_by", "provider", "object_key", "mime", "size", "metadata", "checksum", "status", "created_at"}, &iteratorForCreateCopyResource{rows: arg})
}
