...
func (q *Queries) ListItemsByPaymentSession(ctx context.Context, paymentSessionID uuid.UUID) ([]OrderItem, error) {
...
func (q *Queries) ListPendingPaymentItemsByPaymentSession(ctx context.Context, paymentSessionID uuid.UUID) ([]OrderItem, error) {
