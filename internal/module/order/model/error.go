...
var (
	...
	ErrShipmentCannotCancel   = sharedmodel.NewError(http.StatusConflict, "Shipment cannot be canceled")
	...
	ErrMissingShippingQuote   = sharedmodel.NewError(http.StatusNotFound, "Shipping quote not found for SKU")
	...
	ErrUnknownShipmentOption  = sharedmodel.NewError(http.StatusBadRequest, "Unknown shipment option: %s")
)
