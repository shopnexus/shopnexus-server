...
func (b *InventoryBizHandler) getStockByRef(ctx restate.Context, q inventorydb.Querier, refType inventorydb.InventoryStockRefType, refID uuid.UUID) (inventorydb.InventoryStock, error) {
...
func (b *InventoryBizHandler) GetStock(ctx restate.Context, params GetStockParams) (inventorydb.InventoryStock, error) {
...
func (b *InventoryBizHandler) ListStock(ctx restate.Context, params ListStockParams) (sharedmodel.PaginateResult[inventorydb.InventoryStock], error) {
...
func (b *InventoryBizHandler) CreateStock(ctx restate.Context, params CreateStockParams) (inventorydb.InventoryStock, error) {
	var zero inventorydb.InventoryStock
	if err := validator.Validate(params); err != nil {
		return zero, err
	}
...
func (b *InventoryBizHandler) ListStockHistory(ctx restate.Context, params ListStockHistoryParams) (sharedmodel.PaginateResult[inventorydb.InventoryStockHistory], error) {
...
func (b *InventoryBizHandler) ImportStock(ctx restate.Context, params ImportStockParams) error {
	if err := validator.Validate(params); err != nil {
		return err
	}
...
func (b *InventoryBizHandler) ReserveInventory(ctx restate.Context, params ReserveInventoryParams) ([]ReserveInventoryResult, error) {
...
func (b *InventoryBizHandler) UpdateSerial(ctx restate.Context, params UpdateSerialParams) error {
	if err := validator.Validate(params); err != nil {
		return err
	}
...
func (b *InventoryBizHandler) ListSerial(ctx restate.Context, params ListSerialParams) (sharedmodel.PaginateResult[inventorydb.InventorySerial], error) {
...
func (b *InventoryBizHandler) ListMostTakenSku(ctx restate.Context, params ListMostTakenSkuParams) ([]inventorydb.InventoryStock, error) {
	if err := validator.Validate(params); err != nil {
		return nil, err
	}
