...
type Querier interface {
	...
	CreateBatchBrand(ctx context.Context, arg []CreateBatchBrandParams) *CreateBatchBrandBatchResults
	...
	CreateCopyBrand(ctx context.Context, arg []CreateCopyBrandParams) (int64, error)
	...
	CreateCopyDefaultBrand(ctx context.Context, arg []CreateCopyDefaultBrandParams) (int64, error)
	...
	ListCountBrand(ctx context.Context, arg ListCountBrandParams) ([]ListCountBrandRow, error)
