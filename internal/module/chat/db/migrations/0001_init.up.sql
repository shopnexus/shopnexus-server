...
CREATE UNIQUE INDEX IF NOT EXISTS "conversation_buyer_seller_key" ON "chat"."conversation" ("buyer_id", "seller_id");
CREATE INDEX IF NOT EXISTS "conversation_buyer_id_idx" ON "chat"."conversation" ("buyer_id");
