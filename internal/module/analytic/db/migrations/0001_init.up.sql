...
-- account_id is nullable to support anonymous/guest sessions tracked by session_id.
-- account_number mirrors the account's sequential number for analytics queries
-- without requiring a join when account_id is absent.
...
-- score is a composite ranking value derived from the individual counters.
