...
INSERT INTO "account"."notification" ("account_id", "type", "channel", "title", "content", "metadata")
VALUES ($1, $2, $3, $4, $5, $6)
...
SELECT n.id, n.account_id, n.type, n.channel, n.is_read, n.content, n.date_created, n.date_updated, n.date_sent, n.date_scheduled, n.title, n.metadata, COUNT(*) OVER() as total_count
